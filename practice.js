...
function finder(array){
  ...
  console.log(array.indexOf(rando))
...
function addItem(myGroceryList, itemToAdd){
  var ind = (myGroceryList.indexOf(itemToAdd))
  if(ind === -1){
...
function addTen(numbers){
  ...
  for(i=0; i< numbers.length; i++){
    newNums.push(Number(numbers[i])+10)
  }
  return newNums
}
addTen(numbers)
...
//Code Here
function addEmployee(devMountainEmployees){
  devMountainEmployees.push(tyler, cahlan, ryan, colt)
  return devMountainEmployees
}
addEmployee(devMountainEmployees)
...
//Code Here
function removeEmployee(devMountainEmployees){
...
/*
  Now add three user objects to your users array. Each user object should contain the following properties. name, email
   password, username.
...
var user2 = {
    name: 'Tan Ser',
    email: 'tanser@gmail.com',
    password: 'iLovePHP',
    username: 'PHP'
};
var user3 = {
    name: 'Keith Jones',
    email: 'keithJones@gmail.com',
    password: 'iLovePyton',
    username: 'Python'
};
// Do not edit the code above.
